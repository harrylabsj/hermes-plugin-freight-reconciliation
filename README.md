...
The page is English by default; a Chinese browser (`Accept-Language`) or
`FREIGHT_LANG=zh` switches it, and every model- or file-supplied value is
HTML-escaped. Confirmations only happen here — the model cannot reach the route.
